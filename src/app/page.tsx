        ...
        <div className="mx-auto max-w-lg lg:mx-0 lg:flex lg:w-96 lg:max-w-none lg:flex-col lg:before:flex-1 lg:before:pt-6">
            ...
            <div className="relative">
              <>
                ...
                <p className="mt-4 text-sm/6 text-gray-300">
                  ...
                  Expedita saepe nam distinctio tenetur ea enim quia eligendi
                  non velit dolorem, tempore voluptatum, architecto unde animi
                  aliquid provident dignissimos deserunt recusandae!
                </p>
              </>
            </div>
          </div>
          <div className="flex flex-1 items-end justify-center pb-4 lg:justify-start lg:pb-6">
            <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-500">
              Brought to you by <Link href="#">BearStudio</Link>
            </p>
          </div>
        </div>
      </div>
